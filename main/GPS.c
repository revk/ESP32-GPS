...
834, 821, 807, 793, 779, 764, 749, 734, 719, 703, 687, 671, 654, 637, 620, 603, 586, 569, 552, 534, 517, 499, 482, 465, 447, 430, 413, 396, 379, 362,
345, 328, 312, 296, 280, 265, 250, 235, 220, 206, 192, 178, 165, 152, 140, 128, 116, 105, 95, 85, 75, 66, 58, 50, 43, 36, 30, 24, 19, 14, 10, 7, 4,
2, 1, 0, 0 };
      adjust = cossq[adjust];
               ...
               else
               {
                  ...
                  if (c > 0)
                     while (c--)
                     {
                        ...
                        long d = (long) (p.e - E) * (long) (p.e - E) * adjust / 1000 + (long) (p.n - N) * (long) (p.n - N);
                        if (!*postcode || d < best)
                        {
                           best = d;
